...
# -*- coding: utf-8 -*-
#
# Linux System Administration documentation build configuration file, created by
...
release = now.strftime("%Y-%m-%d %H:%M")
...
#
# html_title = 'Linux System Administration v2018'
...
htmlhelp_basename = 'LinuxSystemAdministrationdoc'
